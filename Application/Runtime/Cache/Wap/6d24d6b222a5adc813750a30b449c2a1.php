...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Public/Wap/css/course_details.css">
</head>
...
<body>
	<div id="app">
		<div class="top"></div>
		<section>
			<h2><?php echo ($teach["teach_title"]); ?></h2>
			<!-- 富文本 -->
			<div><?php echo ($teach["teach_content"]); ?></div>
			<p id="hleep">
				<a class="p_color1 f_size" href="tel:<?php echo ($sys["sys_tel"]); ?>">需要客服帮助？</a>
			</p>
		</section>
	</div>
</body>
