        ...
        WeixinJSBridge.invoke(
                ...
                function(res){
                    ...
                    if(res.err_msg=="get_brand_wcpay_request:ok"){
                        window.location.href="<?php echo U('Index/wallet');?>"
                    }
                }
        );}
	...
	<div id="app" v-clock>
		...
		<div class="content">
			<div class="b_bottom">
				...
				<p class="f_size_23">充值支付</p>
			</div>
			<div>
				<p class="f_size_23">充值金额</p>
				<p class="f_size_30 p_color3">￥<?php echo ($money); ?></p>
			</div>
		</div>
		<div class="payBox">
			<div class="pay2">
				...
				<div class="radio" >
					<img  src="/Public/Wap/images/select2.png" alt=""  />
				</div>
			</div>
		</div>
	</div>
